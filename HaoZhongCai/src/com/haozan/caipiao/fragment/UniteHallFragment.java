...
public class UniteHallFragment
...
// private View view1, view2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Logger.inf("call unite onCreateView");
        
        initData();

        View layout = View.inflate(mContext, R.layout.unite_hall, null);
        setupViews(layout);
        return layout;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        Logger.inf("call unite onActivityCreated");
    ...
    private void initData() {
        ...
        for (int i = 0; i < TYPE_NUM; i++) {
            ...
            arrays.add(array);
            UniteHallListAdapter ad = new UniteHallListAdapter(mParentActivity, array);
            adapter.add(ad);
        }
    ...
    private void setupViews(View layout) {
        title = (TextView) layout.findViewById(R.id.unite_title);

        tab1 = (RelativeLayout) layout.findViewById(R.id.tab1);
        tab2 = (RelativeLayout) layout.findViewById(R.id.tab2);
        ...
        for (int i = 0; i < TYPE_NUM; i++) {
            view[i] = View.inflate(mParentActivity, R.layout.unite_hall_viewflow_left, null);
            ...
            triAngle[i] = (ImageView) layout.findViewById(triAngleIds[i]);
            textView[i] = (TextView) layout.findViewById(textViewIds[i]);
            imgs[i] = (ImageView) layout.findViewById(imgsIds[i]);
            ...
            views.add(view[i]);
            footView[i] = View.inflate(mParentActivity, R.layout.list_item_load_more_view, null);
        }
        ...
        termLayout = (RelativeLayout) layout.findViewById(R.id.bet_top_term_layout);
        termLayout.setOnClickListener(this);
        topArrow = (ImageView) layout.findViewById(R.id.arrow_top);
...
// pullToRefresh[1].onHeaderRefreshComplete();
        ...
        btnUnite = (Button) layout.findViewById(R.id.title_btinit_right);
        ...
        btnUniteRe = (RelativeLayout) layout.findViewById(R.id.re_titleright);
        imgHelp = (LinearLayout) layout.findViewById(R.id.bet_unite_help);
        imgHelp.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtras(bundle);
                intent.setClass(mParentActivity, WebBrowser.class);
                startActivity(intent);
            }
        });
    }
...
// toTopButton.setVisibility(View.GONE);
    ...
    public class GetUniteHallTask
        ...
        protected String doInBackground(Object... params) {
            GetUniteHallService getUniteHall =
                new GetUniteHallService(mParentActivity, orderType, orderby, pageNo[orderType], SIZE,
                                        lottery_id);
            String json = null;
            try {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent();
        intent.setClass(mParentActivity, UniteHallDetail.class);
        Bundle b = new Bundle();
    ...
    private void showPopView() {
        ...
        popupWindowWaySelect = new SelecteTypePopupWindow(mParentActivity, wayDataArray);
