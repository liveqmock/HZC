...
public abstract class BaseProvider
    ...
    /**
     * Creates and updated database on demand when opening it. Helper class to create database the first time
     * the provider is initialized and upgrade it when a new version of the provider needs an updated version
     * of the database.
     */
...
// BaseProvider.this.db = db;
     ...
     */
    protected boolean upgrade(final SQLiteDatabase db, int oldV, final int newV,
...
// }
    ...
    /**
     * Returns the content-provider-style MIME types of the various types accessible through this content
     * provider.
     */
    @Override
    ...
    public Cursor query(final Uri uri, String[] projection, final String selection,
        ...
        BaseTable table = config.getTable(code);
        if (table != null) {
            return table.query(db, getContext(), code - table.mPathIndex, uri, projection, selection,
    ...
    public int update(final Uri uri, final ContentValues values, final String selection,
        ...
        BaseTable table = config.getTable(code);
        if (table != null) {
            return table.update(db, getContext(), code - table.mPathIndex, uri, values, selection,
                                selectionArgs);
        }
        else {
            // #debug
