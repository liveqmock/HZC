...
public class BankListTable
    extends SimpleTable {

    public static final String TABLE_NAME = "banks_table";
    private static final String CREATE_TABLE = "create table if not exists " + TABLE_NAME + "(" + BanksDbBean.ID +
        " integer primary key, " + BanksDbBean.FIRSTCHAR + " char(20)," + BanksDbBean.CHINESENAME + " char(40)," +
        BanksDbBean.KEY + " char(10)," + BanksDbBean.DEPOSIT + " char(20)," + BanksDbBean.CREDIT + " char(20)," + BanksDbBean.LASTUSE +
        " char(20)," + BanksDbBean.RECHARGETYPE + " char(20))";
