package com.haozan.caipiao.wxapi;
...
import com.haozan.caipiao.activity.Hall;
...
//                // 将该app注册到微信
//                api.registerApp(LotteryConfig.APP_ID);      
//            }
//        });
//        
...
//        });
    ...
    private void goToGetMsg() {
        //微信调用客户端时，直接跳到大厅
        Intent intent = new Intent(this, Hall.class);
        intent.putExtras(getIntent());
        startActivity(intent);
        finish();
//     // 初始化一个WXTextObject对象
//        String text =
//            getString(R.string.lottery_name) + " 很好用啊，下载#" + getString(R.string.app_name) + "#试试你的运气,一起发财吧 " +
...
//        finish();
    ...
    private String getTransaction() {
        final GetMessageFromWX.Req req = new GetMessageFromWX.Req(getIntent().getExtras());
