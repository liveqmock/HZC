 ...
 */
public class ChinaUnionPayPluginTopupRequest
    ...
    public ChinaUnionPayPluginTopupRequest(Context context, Handler handler, String money) {
...
// parameter.put("card_no", "6222003602100336373");
    ...
    public void onSuccess(String rspContent, int statusCode) {
        ...
        String mOrderId = RequestResultAnalyse.getData(response, "tradeid");

        Message message = Message.obtain(mHandler, ControlMessage.UNIONPAY_PLUGIN_TOPUP_SUCCESS, mOrderId);
