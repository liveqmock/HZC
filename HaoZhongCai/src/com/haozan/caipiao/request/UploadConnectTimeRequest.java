 ...
 */
public class UploadConnectTimeRequest
    extends Task {
    ...
    public UploadConnectTimeRequest(Context context, String service, long time) {
    ...
    public UploadConnectTimeRequest(Context context, String service, String errorInf, long time) {
        this.mContext = context;
