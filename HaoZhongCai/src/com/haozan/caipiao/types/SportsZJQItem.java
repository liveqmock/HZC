...
public class SportsZJQItem
    ...
    public static final Parcelable.Creator<SportsZJQItem> CREATOR = new Creator<SportsZJQItem>() {
        public SportsZJQItem createFromParcel(Parcel source) {
            SportsZJQItem item = new SportsZJQItem();
        ...
        public SportsZJQItem[] newArray(int size) {
            return new SportsZJQItem[size];
        }
    };
}
