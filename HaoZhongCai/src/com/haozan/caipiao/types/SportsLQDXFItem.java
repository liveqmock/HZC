...
public class SportsLQDXFItem
    ...
    public static final Parcelable.Creator<SportsLQDXFItem> CREATOR = new Creator<SportsLQDXFItem>() {
        public SportsLQDXFItem createFromParcel(Parcel source) {
            SportsLQDXFItem item = new SportsLQDXFItem();
        ...
        public SportsLQDXFItem[] newArray(int size) {
            return new SportsLQDXFItem[size];
        }
    };
}
