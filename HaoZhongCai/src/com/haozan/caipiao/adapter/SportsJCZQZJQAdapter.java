...
public class SportsJCZQZJQAdapter
    extends BaseExpandableListAdapter {
    private Context context;
    private ArrayList<SportsSFCBetGroup> list;
    private OnBallClickListener clickListener;
    public String[] betRe = {"0", "1", "2", "3", "4", "5", "6", "7+"};

    public SportsJCZQZJQAdapter(Context context, ArrayList<SportsSFCBetGroup> list) {
    ...
    public final class ViewHolderChild {
        ...
        private String[] betRe = {"0", "1", "2", "3", "4", "5", "6", "7+"};
        private int[] btns_id = {R.id.zjq_one, R.id.zjq_two, R.id.zjq_three, R.id.zjq_four, R.id.zjq_five,
                R.id.zjq_six, R.id.zjq_seven, R.id.zjq_eight};
        private int[] imgs_id = {R.id.img_01, R.id.img_02, R.id.img_03, R.id.img_04, R.id.img_05,
                R.id.img_06, R.id.img_07, R.id.img_08};
