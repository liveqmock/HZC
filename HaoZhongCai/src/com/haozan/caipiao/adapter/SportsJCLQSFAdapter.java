...
public class SportsJCLQSFAdapter
    ...
    public SportsJCLQSFAdapter(Context context, ArrayList<SportsSFCBetGroup> list) {
...
// }
// SportsLQSFItem sportsItem = list.get(groupPosition).getItemList().get(childPosition);
