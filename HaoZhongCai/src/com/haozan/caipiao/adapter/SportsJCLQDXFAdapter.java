...
public class SportsJCLQDXFAdapter
    extends BaseExpandableListAdapter {
    private Context context;
    private ArrayList<SportsSFCBetGroup> list;
    private OnBallClickListener clickListener;
    private String[] result = {"大分", "小分"};

    public SportsJCLQDXFAdapter(Context context, ArrayList<SportsSFCBetGroup> list) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
        ...
        if (convertView == null) {
            ...
            viewHolder.totalPoints = (TextView) convertView.findViewById(R.id.tv_jclq_total_point);
...
//        }
        ...
        viewHolder.totalPoints.setVisibility(View.VISIBLE);
        viewHolder.totalPoints.setText(sportsItem.getTotalPoints());
        if (!sportsItem.getStatus(0)) {
            viewHolder.win.setText(Html.fromHtml("<font color=\"#A8A8A8\">大分</font>   " +
            ...
            viewHolder.win.setText(Html.fromHtml("<font color=\"#FFFFFF\">大分   " + sportsItem.getOdds()[0] +
                "</font>"));
...
//            viewHolder.img01.setVisibility(View.VISIBLE);
        ...
        if (!sportsItem.getStatus(1)) {
            viewHolder.lose.setText(Html.fromHtml("<font color=\"#A8A8A8\">小分</font>   " +
            ...
            viewHolder.lose.setText(Html.fromHtml("<font color=\"#FFFFFF\">小分   " + sportsItem.getOdds()[1] +
                "</font>"));
