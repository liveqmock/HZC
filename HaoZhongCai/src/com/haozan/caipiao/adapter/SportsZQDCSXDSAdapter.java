...
public class SportsZQDCSXDSAdapter
    extends BaseExpandableListAdapter {
    private Context context;
    private ArrayList<SportsSFCBetGroup> list;
    private OnBallClickListener clickListener;

    public SportsZQDCSXDSAdapter(Context context, ArrayList<SportsSFCBetGroup> list) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.sports_sxds_item_view, null);
