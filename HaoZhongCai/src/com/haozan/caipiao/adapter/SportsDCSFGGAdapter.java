...
public class SportsDCSFGGAdapter
    ...
    public SportsDCSFGGAdapter(Context context, ArrayList<SportsSFCBetGroup> list) {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild,
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.sports_sf_item_view, null);
...
//        viewHolder.time.setText(sportsItem.getEndTime() + "截止");
                ...
                if (viewHolder.analyse_all.getVisibility() == View.VISIBLE) {
                    ...
                    if (null != list.get(groupPosition).getItemList().get(childPosition).getHisCom(0) &&
                        ...
                        SportsSimpleAnalyseTask task =
                            new SportsSimpleAnalyseTask(context, sportsItem.getId(), "dcsfgg");
        ...
        */
        ...
        for (int i = 0; i < viewHolder.btns.length; i++) {
            ...
            if (!sportsItem.getStatus(i)) {
                viewHolder.btns[i].setText(Html.fromHtml("<font color=\"#515151\">" + viewHolder.betRe[i] +
                    "</font>&nbsp;&nbsp;" + "<font color=\"#CA4843\">" + sportsItem.getOdds()[i] +
                    "</font>"));
    ...
    class ClickAction
        ...
        public void onClick(View v) {
            ...
            if (!item.getStatus(index)) {
                button.setText(Html.fromHtml("<font color=\"#515151\">" + betRe[index] +
                                                         "</font>&nbsp;&nbsp;" + "<font color=\"#CA4843\">" + item.getOdds()[index] +
                                                         "</font>"));
