...
public class SportsJCZQBQCAdapter
    extends BaseExpandableListAdapter {
    private Context context;
    private ArrayList<SportsSFCBetGroup> list;
    private OnBallClickListener clickListener;
    public String[] betRe = {"胜胜", "胜平", "胜负", "平胜", "平平", "平负", "负胜", "负平", "负负"};

    public SportsJCZQBQCAdapter(Context context, ArrayList<SportsSFCBetGroup> list) {
    ...
    public final class ViewHolderChild {
        ...
        private String[] betRe = {"胜胜", "胜平", "胜负", "平胜", "平平", "平负", "负胜", "负平", "负负"};
        private Button[] btns = new Button[9];
        private ImageView[] imgs = new ImageView[9];
        private TextView[] tvs = new TextView[6];
        private int[] btns_id = {R.id.bqc_one, R.id.bqc_two, R.id.bqc_three, R.id.bqc_four, R.id.bqc_five,
                R.id.bqc_six, R.id.bqc_seven, R.id.bqc_eight, R.id.bqc_nine};
        private int[] imgs_id = {R.id.img_01, R.id.img_02, R.id.img_03, R.id.img_04, R.id.img_05,
                R.id.img_06, R.id.img_07, R.id.img_08, R.id.img_09};
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild,
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.sports_bqc_item_view, null);
...
// }
        ...
        if (sportsItem.isIfShowAnalyse()) {
            ...
            viewHolder.tvs[3].setText(list.get(groupPosition).getItemList().get(childPosition).getRank(0));
            viewHolder.tvs[5].setText(list.get(groupPosition).getItemList().get(childPosition).getRank(1));
        }
        else {
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                if (null != zhupai && !zhupai.equals("")) {
                                                    viewHolder.tvs[3].setText(zhupai);
                                                }
                                                else {
                                                    viewHolder.tvs[3].setText("-");
                                                }
                                                if (null != kepai && !kepai.equals("")) {
                                                    viewHolder.tvs[5].setText(kepai);
                                                }
                                                else {
                                                    viewHolder.tvs[5].setText("-");
                                                }
        ...
        for (int i = 0; i < viewHolder.btns.length; i++) {
            ...
            if (!sportsItem.getStatus(i)) {
                viewHolder.btns[i].setText(Html.fromHtml("<font color=\"#A8A8A8\">" + viewHolder.betRe[i] +
                    "</font><br>" + "<font color=\"#DB0010\">" + sportsItem.getOdds()[i] + "</font>"));
    ...
    class ClickAction
        ...
        public void onClick(View v) {
            ...
            if (!item.getStatus(index)) {
                button.setText(Html.fromHtml("<font color=\"#A8A8A8\">" + betRe[index] + "</font><br>" +
                    "<font color=\"#DB0010\">" + item.getOdds()[index] + "</font>"));
                button.setBackgroundResource(R.drawable.custom_button_redside_unselected);
                img.setVisibility(View.GONE);
            }
            else {
                button.setText(Html.fromHtml("<font color=\"#FFFFFF\">" + betRe[index] + "<br>" +
                    item.getOdds()[index] + "</font>"));
