/*******************************************************************************
 * Copyright 2011, 2012 Chris Banes. Licensed under the Apache License, Version 2.0 (the "License"); you may
...
import com.haozan.caipiao.widget.pulltorefresh.internal.EmptyViewMethodAccessor;
...
public class PullToRefreshListView
    ...
    protected void resetHeader() {
        ...
        /**
         * Scroll so the View is at the same Y as the ListView header/footer, but only scroll if we've pulled
         * to refresh and it's positioned correctly
         */
    ...
    class InternalListView
        ...
        public void draw(Canvas canvas) {
            /**
             * This is a bit hacky, but ListView has got a bug in it when using Header/Footer Views and the
