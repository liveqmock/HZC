...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private OnHeaderRefreshListener<T> mOnRefreshListener;
				...
				if (mIsBeingDragged) {
					...
					if (mState == RELEASE_TO_REFRESH) {
						if (null != mOnRefreshListener) {
							...
							mOnRefreshListener.onHeaderRefresh(this);
							return true;
	 ...
	 */
	public final void setOnHeaderRefreshListener(OnHeaderRefreshListener<T> listener) {
	 ...
	 *            - Listener to be used when the Widget is set to Refresh
	 */
	public final void setOnHeaderRefreshListener(OnRefreshListener2<T> listener) {
	 ...
	 * @author Chris Banes
	 */
	public static interface OnHeaderRefreshListener<V extends View> {

		/**
		 * onRefresh will be called for both Pull Down from top, and Pull Up
		 * from Bottom
		 */
		public void onHeaderRefresh(final PullToRefreshBase<V> refreshView);
