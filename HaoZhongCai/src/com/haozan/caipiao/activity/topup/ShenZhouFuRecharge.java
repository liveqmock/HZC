...
import com.haozan.caipiao.control.topup.ShenZhouFuTopupControl;
...
/**
 * ShenZhouFuRecharge Activity.
 * @author lugq
 * @create-time 2014-7-25 下午10:27:47
 */
public class ShenZhouFuRecharge extends BasicActivity implements OnClickListener, PopupSelectTypeClickListener {
	
    private static final String[] PHONECARD_TYPE = {"0", "1", "2"};
    private static final String[] PHONECARD_TYPE_DESC = {"中国移动", "中国联通", "中国电信"};
    private static final String[] MONEY = {"1","10", "20", "30", "50", "100", "300", "500"};
    private static final String[] COLLECTED_MONEY = {"1","9", "18", "28", "47", "95", "285", "475"};
    ...
    private ShenZhouFuTopupControl mTopupControl;

    private MyHandler mHandler;
	private TextView rechspinner03_text;

    private static class MyHandler extends WeakReferenceHandler<ShenZhouFuRecharge> {

        public MyHandler(ShenZhouFuRecharge reference) {
            super(reference);
        }

        @Override
        protected void handleMessage(ShenZhouFuRecharge activity, Message msg) {
            switch (msg.what) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shenzhoufu_recharge);
        setupViews();
        init();
    }
    ...
    private void initData() {
        ...
        mTopupControl = new ShenZhouFuTopupControl(this, mHandler);
    }
    ...
    private void init() {
        ...
        rechspinner03_text.setText(Html.fromHtml("<font color='#9D9D9D'>到账：</font>" + COLLECTED_MONEY[moneyIndex])+"元");
    }
    ...
    private void setupViews() {
        ...
        rechspinner03_text = (TextView) findViewById(R.id.rechspinner03_text);
    }

    protected void refreshMoney() {
        //tvAccountedMoney.setText("到账金额:" + COLLECTED_MONEY[moneyIndex]);
        //rechspinner03_text.setText("到账金额:" + COLLECTED_MONEY[moneyIndex]);
        rechspinner03_text.setText(Html.fromHtml("<font color='#9D9D9D'>到账：</font>" + COLLECTED_MONEY[moneyIndex])+"元");
    }
    ...
    public void onClick(View v) {
        ...
        else if (v.getId() == R.id.submit) {		//充值
            if (HttpConnectUtil.isNetworkAvailable(ShenZhouFuRecharge.this)) {
                if (checkInput()) {
                    showConfirmDialog();
                }
            }
        ...
        else if (v.getId() == R.id.dlg_submit) {	//确认充值
            mTopupControl.toTopup(topupCardTypeCode, topupMoney01, topupRealMoney01, etCardNum.getText().toString(), etCardPw.getText().toString());
    ...
    private void showPopupViews() {
        if (popupType == PHONECARD_TYPE_SELECTED) {
            ...
            popupWindowWaySelect = new SelecteTypePopupWindow(ShenZhouFuRecharge.this, topupWayArray);
            ...
            popupWindowWaySelect = new SelecteTypePopupWindow(ShenZhouFuRecharge.this, topupMoneyArray);
            popupWindowWaySelect.init();
            popupWindowWaySelect.setPopupSelectTypeListener(this);
