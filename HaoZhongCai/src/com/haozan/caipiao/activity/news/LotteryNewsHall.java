...
public class LotteryNewsHall
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.news_selection);
        setupViews();
        init();
    }
    ...
    private void setupViews() {
        ...
        for (int i = 0; i < TYPE_NUM; i++) {
            views[i] = inflater.inflate(R.layout.include_new_viewpager_expandable_listview, null);
    ...
    private void init() {
        for (int i = 0; i < TYPE_NUM; i++) {
            ...
            newsList.add(list1);
            NewsExpanableAdapter adapter = new NewsExpanableAdapter(LotteryNewsHall.this, list1);
            ...
            autoLoadListView[i].setOnGroupClickListener(new OnGroupClickListener() {
                ...
                public boolean onGroupClick(ExpandableListView arg0, View arg1, int arg2, long arg3) {
                    ...
                    intent.setClass(LotteryNewsHall.this, LotteryNewsOfOneType.class);
            ...
            autoLoadListView[i].setOnChildClickListener(new OnChildClickListener() {
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    try {
                        ...
                        intent.putExtras(bundle);
                        intent.setClass(LotteryNewsHall.this, NewsCommentList.class);
                        startActivity(intent);
                    }
                    catch (Exception e) {
                        e.printStackTrace();
...
// private int[][] newsTypeArray = { {7, 10, 13, 16, 23}, {8, 11, 14, 17, 24}, {9, 12, 15, 18, 25}};
    ...
    class NewsTask
        ...
        private HashMap<String, String> initHashMap() {
            ...
            parameter.put("pid", LotteryUtils.getPid(LotteryNewsHall.this));
        ...
        protected Object doInBackground(Object... arg0) {
            ConnectService connectNet = new ConnectService(LotteryNewsHall.this);
            String json = null;
            try {
        ...
        protected void onPostExecute(Object json) {
            ...
            if (json == null) {
                ...
                if (status.equals("200")) {
                    ...
                    OperateInfUtils.clearSessionId(LotteryNewsHall.this);
    ...
    public void loadData() {
        if (HttpConnectUtil.isNetworkAvailable(LotteryNewsHall.this)) {
            if (null != task) {
                task.cancel(true);
            }
            task = new NewsTask();
